                ...
                <li class="bg-white shadow-lg rounded-lg p-4">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('books.edit', $book->id) }}"
                            class="bg-blue-500 text-white px-3 py-2 rounded-md transition duration-300 ease-in-out hover:bg-blue-600 hover:text-gray-100">Edit</a>

                        <form class="inline-block" action="{{ route('books.destroy', $book->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button
                                class="bg-red-500 text-white px-3 py-2 rounded-md ml-2 transition duration-300 ease-in-out hover:bg-red-600 hover:text-gray-100">Delete</button>
                        </form>
                    </div>
                </li>
